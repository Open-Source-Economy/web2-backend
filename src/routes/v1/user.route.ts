...
router.get("/available-credit", authenticatedUser, UserController.getAvailableCredit);
router.get("/plan", authenticatedUser, UserController.getPlan);
router.post("/preferred-currency/:currency", authenticatedUser, UserController.setUserPreferredCurrency);
