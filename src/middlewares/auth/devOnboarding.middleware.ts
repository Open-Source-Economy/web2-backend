...
export const authenticatedDeveloperProfileUser = async (req: Request, res: Response, next: () => void) => {
  if (!req.user) {
...
export const checkAuthenticatedDeveloperProfile = (req: Request<any, any, any, any>): DeveloperProfile => {
  // @ts-ignore
