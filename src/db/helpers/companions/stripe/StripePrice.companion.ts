import { Currency, PriceType, StripePrice, StripePriceId, StripeProductId } from "@open-source-economy/api-types";
import { ValidationError, Validator } from "../Validator";

export namespace StripePriceCompanion {
  export function fromBackend(row: any, table_prefix: string = ""): StripePrice | ValidationError {
    ...
    const type = validator.requiredEnum(`${table_prefix}type`, Object.values(PriceType) as PriceType[]);
