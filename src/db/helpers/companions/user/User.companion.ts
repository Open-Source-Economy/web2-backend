import { Currency, Owner, ThirdPartyUser, UserId, UserRole } from "@open-source-economy/api-types";
...
export namespace UserCompanion {
  export function fromRaw(row: any, owner: Owner | null = null): BackendUser | ValidationError {
