...
export namespace VerificationRecordCompanion {
  export function fromBackend(row: any, table_prefix: string = ""): VerificationRecord | ValidationError {
    ...
    const developerResponse = validator.optionalString(`${table_prefix}developer_response`);
    const developerRespondedAt = validator.optionalDate(`${table_prefix}developer_responded_at`);
    ...
    return {
      ...
      developerResponse,
      developerRespondedAt: developerRespondedAt as ISODateTimeString | undefined,
