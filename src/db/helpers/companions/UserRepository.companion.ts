import { Currency, RepositoryUserRole, UserId, UserRepository } from "@open-source-economy/api-types";
import { ValidationError, Validator } from "./Validator";
import { RepositoryIdCompanion } from "./github";

export namespace UserRepositoryCompanion {
  export function fromBackend(row: any, table_prefix: string = ""): UserRepository | ValidationError {
