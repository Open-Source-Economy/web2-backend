...
export namespace ProjectItemCompanion {
  export function fromBackend(row: any, table_prefix: string = ""): ProjectItem | ValidationError {
    ...
    switch (projectItemType) {
      ...
      case ProjectItemType.URL:
        ...
        break;
      default:
        return new ValidationError(`Invalid project item type: ${projectItemType}`, row);
    }
